...
```
    function setPublicPricee(uint120 publicPrice_) public onlyOwner {
...
- The `setPrices` function allows the contract owner to set the public price for minting tokens. It's marked as `public`, meaning it can be called externally.
